...
(function() {
    ...
    demo.pages.Index.prototype = {
        onLoaded: function() {
            ...
            $("#btnUpdate").on('touchend', function() {
                obj.update();
            });
            $("#btnCancel").on('touchend',function() {
                obj.reset();
            });
            $("#users").delegate('.btn-delete', 'touchend', function() {
                obj.deleteUser(this);
            });
            $("#users").delegate(".btn-edit", 'touchend', function() {
                obj.edit(this);
            });
        ...
        createRowHtml: function(user) {
            var html = '<tr data-id=' + user.id + '>\
                            ...
                            <td>\
                                <input type="button" value="edit" class="btn-edit btn btn-primary"/>\
                                <input type="button" value="delete" class="btn-delete btn btn-danger"/>\
                            </td>\
                        </tr>';
            return html;
        },
